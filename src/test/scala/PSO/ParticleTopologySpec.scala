  ...
  "The particles" should {
    "be connected in a ring topology" in {
      within(500.millis) {
        ...
        (1 until particles.length - 1).foreach{ x =>
          ...
          expectMsg(CurrentNeighbourhood(Set(particles(x - 1), particles(x + 1))))
        }
    ...
    "be connected in a grid topology" in {
      within(500.millis) {
        ...
        expectMsg(CurrentNeighbourhood(Set(particles(2), particles(4), particles(8))))
        //bottom left corner
        particles(6) ! GetNeighbourhood
        expectMsg(CurrentNeighbourhood(Set(particles(3), particles(7))))
        //bottom side
        particles(7) ! GetNeighbourhood
        expectMsg(CurrentNeighbourhood(Set(particles(4), particles(6), particles(8))))
        //bottom right corner
